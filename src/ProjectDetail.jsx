          ...
          <div className="md:col-span-4">
            <div className="bg-white border border-gray-100 rounded-3xl p-7 sticky top-8">
              ...
              <div className="mt-8 space-y-3">
                <a href="#" className="block text-center border border-gray-300 hover:border-gray-400 py-3 rounded-2xl font-medium transition-all">
                  View Source Code
                </a>
                <a href="#" className="block text-center bg-[#F59E0B] hover:bg-amber-400 text-black py-3 rounded-2xl font-semibold transition-all">
                  View Live Demo
                </a>
              </div>
            </div>

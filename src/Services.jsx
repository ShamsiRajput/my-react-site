...
const Services = () => {
  const services = [
    ...
    { icon: <FaPalette className="text-4xl" />, title: "UI/UX Design", desc: "Beautiful and user-friendly interfaces.", tech: "Figma • Canva" },
    ...
    { icon: <FaRocket className="text-4xl" />, title: "Branding & Strategy", desc: "Complete brand identity solutions.", tech: "Strategy & Design" },
  ];
